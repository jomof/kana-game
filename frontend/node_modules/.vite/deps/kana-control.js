...
// node_modules/kana-control/node_modules/kotogram/dist/kotogram.js
function splitKotogram(kotogram) {
  const pattern = /⌈[^⌉]*⌉/g;
  const matches = kotogram.match(pattern);
  return matches || [];
}
var POS1_MAP_VALUES = /* @__PURE__ */ new Set([
  "general",
  "proper-noun",
  "common-noun",
  "numeral",
...
var POS2_MAP_VALUES = /* @__PURE__ */ new Set([
  "general",
  "verbal-suru",
  "verbal-suru-adj",
  "adverbial",
...
var POS3_MAP_VALUES = /* @__PURE__ */ new Set(["general", "country", "given-name", "surname"]);
var CONJUGATED_TYPE_MAP_VALUES = /* @__PURE__ */ new Set([
  // Auxiliary verbs
  "aux-ta",
  "aux-da",
  "aux-desu",
...
var CONJUGATED_FORM_MAP_VALUES = /* @__PURE__ */ new Set([
  "terminal",
  "terminal-nasal",
  "terminal-geminate",
  "terminal-fused",
...
function extractTokenFeatures(token) {
  const feature = {
    surface: "",
    pos: "",
    posDetail1: "",
...
// node_modules/kana-control/node_modules/kotogram/dist/analysis.js
var FormalityLevel;
(function(FormalityLevel2) {
  FormalityLevel2["VERY_FORMAL"] = "very_formal";
  FormalityLevel2["FORMAL"] = "formal";
  FormalityLevel2["NEUTRAL"] = "neutral";
  FormalityLevel2["CASUAL"] = "casual";
  FormalityLevel2["VERY_CASUAL"] = "very_casual";
  FormalityLevel2["UNPRAGMATIC_FORMALITY"] = "unpragmatic_formality";
})(FormalityLevel || (FormalityLevel = {}));
var GenderLevel;
(function(GenderLevel2) {
  GenderLevel2["MASCULINE"] = "masculine";
  GenderLevel2["FEMININE"] = "feminine";
  GenderLevel2["NEUTRAL"] = "neutral";
  GenderLevel2["UNPRAGMATIC_GENDER"] = "unpragmatic_gender";
})(GenderLevel || (GenderLevel = {}));
var RegisterLevel;
(function(RegisterLevel2) {
  RegisterLevel2["SONKEIGO"] = "sonkeigo";
  RegisterLevel2["KENJOGO"] = "kenjogo";
  RegisterLevel2["KANSAIBEN"] = "kansaiben";
  RegisterLevel2["HAKATABEN"] = "hakataben";
  RegisterLevel2["KYOSHIGO"] = "kyoshigo";
  RegisterLevel2["NETSLANG"] = "netslang";
  RegisterLevel2["OJOUSAMA"] = "ojousama";
  RegisterLevel2["GUNTAI"] = "guntai";
  RegisterLevel2["JOSEIGO"] = "joseigo";
  RegisterLevel2["DANSEIGO"] = "danseigo";
  RegisterLevel2["BURIKKO"] = "burikko";
  RegisterLevel2["NEUTRAL"] = "neutral";
  RegisterLevel2["TOHOKU"] = "tohoku";
  RegisterLevel2["BUSHI"] = "bushi";
})(RegisterLevel || (RegisterLevel = {}));

// node_modules/kana-control/kana-control-logic.js
...
function getGroupsWithMaxMarkedTokens(groups) {
  if (groups.length === 0) {
    return [];
  }
...
function selectBestGroup(groups, answerGrammar) {
  if (groups.length === 0)
  ...
  const scoredCandidates = candidates.map((group) => {
    ...
    const score = grammar && grammar.formality_score !== void 0 && grammar.gender_score !== void 0 ? grammar.formality_score ** 2 + grammar.gender_score ** 2 : 1e3;
...
function parseKotogramToTokens(kotogram) {
  ...
  return tokenStrings.map((tokenStr) => {
    ...
    const hiraganaReading = features.reading ? toHiragana(features.reading) : toHiragana(features.surface);
    return {
...
async function makeQuestion(english, japanese, answerGrammar) {
...
function parseEnglishString(eng) {
...
// node_modules/kana-control/kana-control.js
...
var DEFAULT_INITIAL_SCORE = 100;
var DEFAULT_CORRECT_GUESS_FACTOR = 0.95;
var DEFAULT_INCORRECT_GUESS_FACTOR = 0.7;
var _a;
var KanaControl = (_a = class extends LitElement {
  constructor() {
    super(...arguments);
    this.question = null;
    this.parsedEnglish = [];
    ...
    this._revealedHintIndices = /* @__PURE__ */ new Set();
  ...
  render() {
    ...
    return html`
      ...
      ${this.parsedEnglish.length > 0 ? html`
            <div id="english" part="english">
              ${this.parsedEnglish.map((part, index) => html`
                  ...
                  >
                    ${this._furiganaVisibility[index] && part.furigana ? html`<ruby
      ...
      ${this.question ? html`<div id="skeleton" part="skeleton">${this._renderSkeleton()}</div>` : null}
      ...
      ${this.debug && this.question ? html`<div id="debug-output" part="debug" style="margin: 10px 0; padding: 10px; background: #f5f5f5; border-radius: 4px; font-family: monospace; font-size: 14px;">
  ...
  _getEventDetail() {
    ...
    const englishHints = Array.from(this._revealedHintIndices).sort((a, b) => a - b).map((i) => this.parsedEnglish[i].englishWord);
    return {
      finalSkeleton,
  ...
  _handleEnglishWordClick(index) {
    if (this.parsedEnglish && this.parsedEnglish[index] && this.parsedEnglish[index].furigana) {
    ...
    return html`
      ...
      if (this._revealedAnswer) {
        ...
        if (isMissed && t.reading) {
          const hiragana = toHiragana(t.reading);
          const surfaceHiragana = toHiragana(t.surface_form);
