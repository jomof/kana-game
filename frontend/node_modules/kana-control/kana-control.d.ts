...
export declare class KanaControl extends LitElement {
     ...
     */
    private _expandedGrammarAnswer;
    /**
    ...
    private _toggleGrammarDetail;
    private _renderGrammarBadges;
    private _renderGrammarDetail;
